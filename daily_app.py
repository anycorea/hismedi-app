...
st.markdown(
    ...
    <style>
      ...
      section[data-testid="stSidebar"] div[data-testid="stSidebarContent"]{ margin-top:-0.8rem!important; }
      section[data-testid="stSidebar"] div[data-testid="stSidebarUserContent"]{ margin-top:-0.8rem!important; }
